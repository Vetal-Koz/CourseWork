...
public class DynamicTreeNew extends JPanel {
    protected DefaultMutableTreeNode rootNode;
    public DefaultTreeModel treeModel;
    public JTree tree;
    private Toolkit toolkit = Toolkit.getDefaultToolkit();

    public DynamicTreeNew(Uniobject uniobject) {
        super(new GridLayout(1,0));
        StyleUtil.setDefaultsStyles();
        rootNode = new DefaultMutableTreeNode(uniobject);
        treeModel = new DefaultTreeModel(rootNode);
        treeModel.addTreeModelListener(new DynamicTreeNew.MyTreeModelListener());
...
//        tree.setEditable(true);
        ...
        tree.setFont(font);
        java.util.List<DefaultMutableTreeNode> usedNodes = new ArrayList<>();
                    ...
                    if (path != null) {
                        ...
                        if (node != null) {
                            if (!usedNodes.contains(node)) {
                                java.util.List<Uniobject> uniobjectList = generateRelatedNode(node);
                            ...
                            if (node.equals(rootNode)) {
                                ...
                                popUpMenu.getRelatedClassesFrame().addWindowListener(new WindowAdapter() {
                                    ...
                                    public void windowClosed(WindowEvent e) {
                                        java.util.List<Uniobject> updateUniobjects = UniobjectDao.searchRelativeObjectsToObjectByMajor(fillObject);
    ...
    private java.util.List<Uniobject> generateRelatedNode(DefaultMutableTreeNode node) {
